...
namespace CS{
	...
	{
		sockaddr_un server_addr_ = Init(send_fd_name_);
	...
	{
		sockaddr_un server_addr_ = Init(FD_APLtoCS);
	...
	/**
	 * @fn	void UdpSendInterface::IsStreamSendtoCs(sockaddr_un server_addr_, int lane_id_, int src_stid_, int dst_stid_, short retry_level_, int retry_lifetime_, std::string payload_, int length_)
	 *
	 ...
	 */
	//void UdpSendInterface::IsStreamSendtoCs(sockaddr_un server_addr_, int lane_id_, int src_stid_, int dst_stid_, short retry_level_, int retry_lifetime_, char *payload_, int length_)
	void UdpSendInterface::IsStreamSendtoCs(sockaddr_un server_addr_, unsigned long long lane_id_, unsigned long long src_stid_, unsigned long long dst_stid_, short retry_level_, int retry_lifetime_, char *payload_, int length_, const std::string &confDirPath, bool doLog)
	{
		buf_.src_station_id = src_stid_;
		buf_.dst_station_id = dst_stid_;
		buf_.retry_level = retry_level_;
	 ...
	 */
	//void UdpSendInterface::IsStreamSendtoCs(sockaddr_un server_addr_, int lane_id_, int src_stid_, int dst_stid_, short retry_level_, int retry_lifetime_, char *payload_, int length_)
	void UdpSendInterface::IsStreamSendtoCs(sockaddr_un server_addr_, unsigned long long lane_id_, unsigned long long src_stid_, unsigned long long dst_stid_, short retry_level_, int retry_lifetime_, char *payload_, int length_, const std::string &confDirPath)
	{
		IsStreamSendtoCs(server_addr_, lane_id_, src_stid_, dst_stid_, retry_level_, retry_lifetime_, payload_, length_, confDirPath, false);
	}
	/**
	 * @fn	void UdpSendInterface::IsStreamSendtoCs(sockaddr_un server_addr_, int lane_id_, int src_stid_, int dst_stid_, short retry_level_, int retry_lifetime_, std::string payload_)
	 *
	 * @brief	IS送信インタフェース
	 *
	 * @author	Nagoya University
	 ...
	 * @param			payload			送信データペイロード部
	 */
	//void UdpSendInterface::IsStreamSendtoCs(sockaddr_un server_addr_, int lane_id_, int src_stid_, int dst_stid_, short retry_level_, int retry_lifetime_, std::string payload_)
	void UdpSendInterface::IsStreamSendtoCs(sockaddr_un server_addr_, unsigned long long lane_id_, unsigned long long src_stid_, unsigned long long dst_stid_, short retry_level_, int retry_lifetime_, const std::string &payload_, const std::string &confDirPath)
	{
		IsStreamSendtoCs(server_addr_, lane_id_, src_stid_, dst_stid_, retry_level_, retry_lifetime_, (char *)payload_.c_str(), payload_.length(), confDirPath);
	}
	/**
	 * @fn	void UdpSendInterface::IsStreamSendtoCsInShortSize(sockaddr_un server_addr_, int lane_id_, int src_stid_, int dst_stid_, std::string payload_, int length_)
	 *
	...
	void UdpSendInterface::IsStreamSendtoCsInShortSize(sockaddr_un server_addr_, unsigned long long lane_id_, unsigned long long src_stid_, unsigned long long dst_stid_, char *payload_, int length_)
	{
		buf_.src_station_id = src_stid_;
		buf_.dst_station_id = dst_stid_;
		buf_.retry_level = 0;
	 ...
	 */
	//int UdpSendInterface::IsStreamSendtoCsPriority(sockaddr_un server_addr_, int lane_id_, int src_stid_, int dst_stid_, short retry_level_, int retry_lifetime_, int priority_level_, std::string payload_)
	int UdpSendInterface::IsStreamSendtoCsPriority(sockaddr_un server_addr_, unsigned long long lane_id_, unsigned long long src_stid_, unsigned long long dst_stid_, short retry_level_, int retry_lifetime_, int priority_level_, const std::string &payload_, const std::string &confDirPath)
	{
		int res = 0;
		buf_.src_station_id = src_stid_;
		buf_.dst_station_id = dst_stid_;
