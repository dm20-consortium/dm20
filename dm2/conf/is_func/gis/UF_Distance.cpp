...
* @return    double
*/
extern "C" vector< vector<string> > UF_DISTANCE(vector< vector<string> > argList)
{
  //printf("UF_Distance called!\n");
  ...
  for(int i=0; i<argList.size(); i++)
  {
    ...
    // 表示形式に整形
    string retString = to_string(distance);
