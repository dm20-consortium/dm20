...
/**
* LINESTRINGの最後のポイントをPOINTで返却する。
* @author    Nagoya University
* @date      2020/03/10
* @param     引数1=geometry(LINESTRING)
* @return    geometry(POINT)
*/
extern "C" vector< vector<string> > UF_ENDPOINT(vector< vector<string> > argList)
{
  //printf("UF_EndPoint called!\n");
  ...
  for(int i=0; i<argList.size(); i++)
  {
    ...
    GEOSGeometry* point = GEOSGeomGetEndPoint(g1);
