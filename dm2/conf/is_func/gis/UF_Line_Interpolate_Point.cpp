...
/**
* LINESTRINGと割合から内挿点を返却する。
* @author    Nagoya University
* @date      2020/03/12
* @param     引数1=geometry
* @return    geometry
*/
extern "C" vector< vector<string> > UF_LINE_INTERPOLATE_POINT(vector< vector<string> > argList)
{
  //printf("UF_Line_Interpolate_Point called!\n");
  ...
  for(int i=0; i<argList.size(); i++)
  {
    ...
    // LINESTRINGと割合から内挿点を取得
    GEOSGeometry* geom = GEOSInterpolateNormalized(g1,a2);
  ...
  //printf("UF_Line_Interpolate_Point end!\n");
  return retList;
}
