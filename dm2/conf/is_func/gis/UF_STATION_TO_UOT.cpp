...
* @return    double
*/
extern "C" vector< vector<string> > UF_STATION_TO_UOT(vector< vector<string> > argList)
{
  vector< vector<string> > retList; // ISに返却する結果2次元配列(retList[row][col])

  double wakashiba_lon = 139.948934;
  double kakeiken_lon =  139.941620;
