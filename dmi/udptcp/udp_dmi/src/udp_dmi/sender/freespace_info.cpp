...
DEFINE_int32(target_port, 54346, "Port of the target");
...
DEFINE_string(
    continuous_query,
    "master sysTimer100msec select * from freespace_info_0_8_1 [range 300 msec]",
    "A query for DM objects");
DEFINE_uint32(
    dm_connection_try_count,
    3,
    "Attempt to connect a specified number of time");
DEFINE_uint32(data_num_per_frame, 3, "Data num per frame (<= 3)");
DEFINE_uint32(
    frame_rate_max_msec,
    33,
