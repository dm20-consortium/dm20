...
namespace test_util {
  ...
  std::vector<std::string> CreateNameList_f() {
    return {
      ...
      "position_begin_geodetic_system",
  ...
  QueryResult CreateDatas_f(
    ...
    const std::string& position_begin_geodetic_system,
    ...
    const std::string& position_end_geodetic_system,
    ...
    for (const auto name : name_list) {
      ...
      else if (name == "position_begin_geodetic_system") o[name] = position_begin_geodetic_system;
      ...
      else if (name == "position_end_geodetic_system") o[name] = position_end_geodetic_system;
  ...
  struct CandidateTestCase_f {
    CandidateTestCase_f() {
      ...
      map["position_begin_geodetic_system"] = {"456"};
      ...
      map["position_end_geodetic_system"] = {"654"};
  ...
  ResultSet CreateResultSet_f(CandidateTestCase_f& input) {
    ...
    for (size_t i = 0; i < input.length; ++i) {
      datas_list.push_back(CreateDatas_f(
        ...
        input.map["position_begin_geodetic_system"][i],
        ...
        input.map["position_end_geodetic_system"][i],
